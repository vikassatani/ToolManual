...
import { GenerateSalesmanReportComponent } from './salesmanReport.component';
...
const routes: Routes = [
    {
        ...
        "children": [
            {
                "path": "",
                "component": GenerateSalesmanReportComponent
            }
        ]
    }
];
@NgModule({
    imports: [
        ...
        GenerateSalesmanReportComponent
    ],
    providers: [ServerService],
})
export class GenerateSalesmanReportModule {
}
