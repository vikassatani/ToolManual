...
import { GenerateCustomerReportComponent } from './CustomerReport.component';
...
const routes: Routes = [
    {
        ...
        "children": [
            {
                "path": "",
                "component": GenerateCustomerReportComponent
            }
        ]
    }
];
@NgModule({
    imports: [
        ...
        GenerateCustomerReportComponent
    ],
    providers: [ServerService],
})
export class GenerateCustomerReportModule {
}
